 ...
 * @pre
 * @post
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(!bestandsnaam.empty(), "BestandNaam mag niet leeg zijn.");
 * @post ENSURE(!success || situatie.verificeerConsistentie(), "Bij succesvolle parsing moet de situatie consistent zijn." );
 *
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor baan mag niet null zijn.");
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor Voertuig mag niet null zijn.");
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor Verkeerslicht mag niet null zijn.");
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor VoertuigGenerator mag niet null zijn.");
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor Bushalte mag niet null zijn.");
 */
 ...
 * @pre REQUIRE(properlyInitialized(),"BestandLezer werd niet correct ingesteld");
 * @pre REQUIRE(elem != nullptr, "XML-element voor Kruispunt mag niet null zijn.");
 */
